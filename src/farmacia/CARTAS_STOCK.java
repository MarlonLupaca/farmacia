...
public class CARTAS_STOCK extends javax.swing.JPanel {

    /**
     * Creates new form Carta
     */
    
    public CARTAS_STOCK(int codigo, String nombre, String laboratorio, String principio, String ubicacion, int stock) {
        initComponents();
        this.lbcodigo.setText("CODIGO: "+ codigo);
        this.lbnombre.setText("NOMBRE: "+ nombre);
        this.lblaboratorio.setText("LABORATORIO: "+ laboratorio);
        this.lbprincipio.setText("PRINCIPIO ACTIVO: "+ principio);
        this.lbstock.setText("STOCK: "+ stock);
        this.lbubicacion.setText("UBICACION: "+ ubicacion);
