...
public class REGISTRO_CLIENTE extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        correo_electronico.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                correo_electronicoKeyPressed(evt);
            }
        });
        ...
        descripcion_medica.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                descripcion_medicaKeyPressed(evt);
            }
        });
    ...
    private void correo_electronicoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_correo_electronicoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            nombre.requestFocus();
        }
    }//GEN-LAST:event_correo_electronicoKeyPressed

    private void nombreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombreKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            descripcion_medica.requestFocus();
        }
    }//GEN-LAST:event_nombreKeyPressed

    private void descripcion_medicaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_descripcion_medicaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_descripcion_medicaKeyPressed
