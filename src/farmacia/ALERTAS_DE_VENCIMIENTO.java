...
public class ALERTAS_DE_VENCIMIENTO extends javax.swing.JPanel {
    private DAOProductos dao = new DAOProductoImpl();
    
    public ALERTAS_DE_VENCIMIENTO() {
        initComponents();
    ...
    public void agregarCartasDesdeLista() {
        try {
            List <producto> listaAlertas = dao.listar_de_vencimiento();
            removeAll();
            ...
            for (producto contenido : listaAlertas) {
                ...
                String fechaVencimiento = contenido.getFecha_vencimiento();
                int stock = contenido.getStock();
                

                CARTAS_VENCIMIENTO nuevaCarta = new CARTAS_VENCIMIENTO(codigo, nombre, ubicacion, pricipio, fechaVencimiento,stock);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALERTAS DE VENCIMIENTO");
