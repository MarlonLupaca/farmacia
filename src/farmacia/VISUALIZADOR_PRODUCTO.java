 ...
 */
public class VISUALIZADOR_PRODUCTO extends javax.swing.JFrame {
    static int a=0;
    ...
    public VISUALIZADOR_PRODUCTO(producto p) {
        initComponents();
        ...
        codigo_digemid.setEditable(false);
        stock.setEditable(false);
        unidad_blister.setEditable(false);
        laboratorio.setEditable(false);
        principio_activo.setEditable(false);
        lote.setEditable(false);
        precio_unitario.setEditable(false);
        minimo_aviso.setEditable(false);
        unidad_caja.setEditable(false);
        ubicacion.setEditable(false);
        precio_blister.setEditable(false);
        precio_caja.setEditable(false);
